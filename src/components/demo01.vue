         ...
         var lis = ['日期', 'open', 'close', 'lowest', 'highest', 'vol'];
          axios
            ...
            .then(function(respone){
              ...
              for(i=0;i<10;i++)
              {
                   console.log('rdata:'+respone.data.data[i].date);
                  
                  
                  
                _this.chartData.rows[i][0]=respone.data.data[i].date;
                 console.log('cdata:'+_this.chartData.rows[i][0]);
                _this.chartData.rows[i][1]=respone.data.data[i].open_price;
                _this.chartData.rows[i][2]=respone.data.data[i].close_price;
                _this.chartData.rows[i][3]=respone.data.data[i].low_price;
                _this.chartData.rows[i][4]=respone.data.data[i].high_price;
                _this.chartData.rows[i][5]=respone.data.data[i].trade_volume;
